																	   ...
																	   ForwardScanDirection)))
	{
		...
		Datum forcePushdownDatum =
			heap_getattr(pgDistObjectTup,
						 ...
						 pgDistObjectDesc,
						 &forcePushdownIsNull);
		bool forcePushdown = BoolGetDatum(forcePushdownDatum);
		...
		{
			forcePushdown = false;
			forcePushdownList = lappend(forcePushdownList, (bool *) &forcePushdown);
		}
		else
		{
			forcePushdownList = lappend(forcePushdownList, (bool *) &forcePushdown);
									...
									List *forcePushdowns)
{
		 ...
		 currentObjectCounter++)
	{
		...
		bool forcePushdown = *(bool *) (list_nth(forcePushdowns, currentObjectCounter));
		List *names = NIL;
		List *args = NIL;
